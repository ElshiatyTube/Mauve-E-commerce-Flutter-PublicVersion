...
class ProductGridItem extends StatelessWidget {
  ...
  const ProductGridItem({Key? key, required this.productItem,required this.isSuggested}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: SizedBox(
        width: isSuggested? MediaQuery.of(context).size.width / 2  : double.infinity,
        child: Card(
          ...
          child: Column(
            ...
            children: [
              Stack(
                ...
                children: [
                  CachedNetworkImage(
                    width: isSuggested? 160.0 : double.infinity,
                    height: 85.0,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    (productItem.size == null && !isSuggested) ? Column(
                      children: const[
                         SizedBox(height:6.0 ),
